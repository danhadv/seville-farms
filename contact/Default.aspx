...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" Runat="Server">
   <div class="page-content page-row">
       <div class="col-left" style="font-size: .85em;">
           ...
           <p>
                <strong class="contact-facility-font">Mansfield<br /></strong>
                <strong><i class="fa fa-user"></i> Brenda Horton<br /></strong>
                <i class="fa fa-phone"></i> <a href="tel:817-276-6603">817-276-6603</a><br />
                <i class="fa fa-envelope"></i><a href="mailto:bhorton@sevillefarms.com">bhorton@sevillefarms.com</a>
            </p>
            <p>
                <strong class="contact-facility-font">Tyler<br /></strong>
                <strong><i class="fa fa-user"></i>Connie Winters<br /></strong>
                <i class="fa fa-phone"></i><a href="tel:817-276-6641">817-276-6641</a><br />
                <i class="fa fa-envelope"></i><a href="mailto:cwinter@sevillefarms.com">cwinter@sevillefarms.com</a>
            </p>
            <p>
